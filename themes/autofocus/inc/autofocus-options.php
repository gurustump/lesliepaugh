...
function optionsframework_options() {
	...
	$options[] = array(	"name" => __( 'Text in Footer', 'autofocus' ),
						...
						"std" => '&copy;2011 <a href=\"' . home_url( '/' ) . '" title="' . esc_attr( get_bloginfo( 'name', 'display' ) ) . '" rel="home">' . get_bloginfo( 'name', 'display' ) . '</a>. All rights reserved. Proudly powered by <a href="http://wordpress.org/" title="Semantic Personal Publishing Platform" rel="generator">WordPress</a>. Built with the <a class="theme-link" href="http://fthrwght.com/autofocus/" title="AutoFocus 2.0" rel="theme">AutoFocus 2.0 Theme</a>.',
						"type" => "textarea",
