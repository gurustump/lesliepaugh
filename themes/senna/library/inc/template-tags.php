...
function wpgrade_content_nav( $nav_id ) {
	...
	<?php if ( is_single() ) : // navigation links for single posts ?>
		<?php next_post_link( '%link', '<i class="icon-chevron-left"></i>' ); ?>
		<?php echo '<a href="'.get_portfolio_page_link().'"><i class="icon-th"></i></a>' ?>
		<?php previous_post_link( '%link', '<i class="icon-chevron-right"></i>' ); ?>
