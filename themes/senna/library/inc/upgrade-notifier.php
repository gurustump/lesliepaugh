...
define( 'NOTIFIER_THEME_NAME', 'Senna' ); // The theme name
define( 'NOTIFIER_THEME_SHORTNAME', 'senna' ); // The theme name
define( 'NOTIFIER_XML_FILE', 'http://pixelgrade.com/updates/senna.xml' ); // The remote notifier XML file containing the latest version of the theme and changelog
...
function wpGrade_check_if_new_version(){
	...
	$current= explode('.',WPGRADE_VERSION);
	$newversion=false;
