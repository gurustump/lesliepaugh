...
<!--[if gt IE 8]><!--> <html <?php language_attributes(); ?> class="no-js <?php if ( $wpGrade_Options->get('bw_portfolio_filter') ){ echo "bw-images"; } else { echo ''; } ?> color1 <?php if ( $wpGrade_Options->get('header_fixed') ){ echo "l-header-fixed"; } else { echo ''; } ?>" data-smooth-scroll="<?php if ( $wpGrade_Options->get('use_smooth_scrool') ){ echo "on"; } else { echo 'off'; } ?>"><!--<![endif]-->
