...
//    );
    ...
    $sections[] = array(
        ...
        'desc' => __('<p class="description">Theme shared on WPLOCKER.COM - Welcome to the Senna options panel! You can switch between option groups by using the left-hand tabs.</p>', wpGrade_txtd),
        'fields' => array(
            array(
            ...
            array(
                ...
                'type' => 'info',
                'desc' => __('<h2>Theme shared on WPLOCKER.COM - Branding Options</h2>', wpGrade_txtd)
            ),
            array(
                'id' => 'main_logo',
                'type' => 'upload',
