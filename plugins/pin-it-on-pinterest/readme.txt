...
To see a video of it in use, go to http://flauntyoursite.com/pin-it-on-pinterest/
...
1. Download the `pin-it-on-pinterest.zip` to your computer. 
2. Upload `pin-it-on-pinterest.zip` to your `/wp-content/plugins/` directory using an FTP program
...
1. The Pin This On Pinterest plugin offers up a screen in which you fill out what Description and Photo will show up when people press the Pin It button.
2. Pin It button displayed underneath your post.
...
* Fixed Button dissapearing problem when updating posts.
